...
\aufgabe{3}
  ...
  \begin{tikzpicture}[scale=1, every entity/.style={fill=blue,minimum height=5mm,minimum width=10mm},every relationship/.style={fill=green,minimum height=5mm,minimum width=5mm}]
